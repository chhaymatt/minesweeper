...
public class Game {
	...
	public Game(int boardSize, int mines) {
		...
		System.out.println(ConsoleColours.CYAN + "The board is " + boardSize + " by " + boardSize + " and contains " + mines + " mines" + ConsoleColours.RESET);
		generateMines();
	}
	...
	public void turn(int x, int y) {
		if (board[x][y].equals(unknown)) {
			...
			System.out.println("");
			System.out.println(ConsoleColours.RED_BACKGROUND + "Boom! Oh no, there was a mine at " + x + ", " + y + "!" + ConsoleColours.RESET);
			this.isDone = true;
			displayBoard(boardEnd);
		} else {
			System.out.println("");
			System.out.println(ConsoleColours.YELLOW + "Try another tile at " + x + ", " + y + " was already revealed" + ConsoleColours.RESET);
		}
	}
